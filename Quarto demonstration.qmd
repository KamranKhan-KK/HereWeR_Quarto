...
author:
  - name: Kamran Khan 
    ...
    affiliation: PCTU QMUL
    affiliation-url: https://www.qmul.ac.uk/pctu/
...
::: {layout-ncol=2}
![Penguin species drawing by Allison Horst](images/penguin_species.png){#fig-penguins}

![Explaining bill dimensions](images/culmen_depth.png){#fig-bill}
:::
